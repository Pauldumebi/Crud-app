<?php
   ...
   if(isset($_POST["submit"])) {
      ...
      $ConnectingDB;
      $sql = "UPDATE records SET EmployeeName='$EmployeeName', SSN='$SSN', Dept='$Dept', Salary='$Salary', HomeAddress='$HomeAddress' WHERE id='$SearchQueryParameter'";
      $Execute = $ConnectingDB->query($sql);
      
      if ($Execute) {
         echo '<script>window.open("databaseResult.php?id=Record Updated Successfully", "_self")</script>';
      } else {
         echo "error";
      }
   }
